...
class SampleReader:
    ...
    def get_histone(self, Test=False):
        ...
        if Test is False:
            histone = pd.read_csv(self.histone_path + 'Train' + '.csv', header=None, index_col=None, dtype="float32")
        else:
            histone = pd.read_csv(self.histone_path + 'Test' + '.csv', header=None, index_col=None, dtype="float32")
